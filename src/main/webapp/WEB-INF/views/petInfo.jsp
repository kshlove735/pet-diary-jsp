    ...
    <div class="popup-content">
        ...
        <form id="petUpdateForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="breed" name="breed" value="${petInfo.breed}" placeholder="품종 (1~50자)" maxlength="50" required>
                <div id="breedError" class="error"></div>
            </div>
            <div class="form-group">
                <label for="birthDate">생년월일</label>
                <input type="date" id="birthDate" name="birthDate" value="${petInfo.birthDate}" max="<%= java.time.LocalDate.now() %>" required>
            ...
            <div class="form-group">
                ...
                <input type="number" id="weight" name="weight" value="${petInfo.weight}" placeholder="몸무게 (0.01~999.99kg)" step="0.01" min="0.01"
                    max="999.99" required>
                <div id="weightError" class="error"></div>
            </div>
            <div class="form-group">
                <label for="description">설명</label>
                <textarea id="description" name="description" placeholder="반려견에 대한 설명 (최대 500자)" maxlength="500"><c:if test="${not empty petInfo.description}"><c:out value="${petInfo.description}"/></c:if></textarea>
